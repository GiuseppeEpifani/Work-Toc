        ...
        <div class="col-md-8">
            <div class="card sombra">
                ...
                <div class="card-header d-flex justify-content-between align-items-center text-center card_header">
                    <div class="container"><span><i class="fas fa-user-shield" style="font-size: 30px;"></i>
                            {{ __('Nuevo Administrador') }}</span></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Con.
                                Contraseña</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary"
                                    style="background: #000 !important; color: #ffffff !important;">
                                    {{ __('Registrar') }}
                                </button>
                            </div>
                        </div>
